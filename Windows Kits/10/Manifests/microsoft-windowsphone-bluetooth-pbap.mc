...
<assembly
  ...
  <instrumentation
    ...
    <events xmlns="http://schemas.microsoft.com/win/2004/08/events">
      <provider
        guid="{2ff93dc3-eea4-4dda-bdc5-8539e1490d32}"
        message="$(string.Provider.Name)"
        name="Microsoft-WindowsPhone-Bluetooth-PBAP"
        resourceFileName="BthpbapService.dll"
        messageFileName="BthpbapService.dll"
        symbol="BLUETOOTH_PBAP_PROVIDER_GUID"
        >
        <keywords>
          <keyword
  ...
  <localization>
    <resources culture="en-US">
      <stringTable>
        <string
          id="Provider.Name"
          value="Microsoft-WindowsPhone-Bluetooth-PBAP"
          />
        <string
          id="Keyword.Debug"
          value="Debug"
