...
#define DEFAULT_ADDRESS_SIZE_MSM8974                        0x200
...

{
    ...
    MSM8974SetBaud(&DebugPort->Port, DebugPort->Port.Baud);
...

{
    ...
    if (*CompDbgPortsPresent == FALSE) {
            MSM8974SetBaud(pPort, pPort->Baud);
...
KD_HARDWARE_LAYER_DRIVER MSM8974HardwareLayerDriver = {
    MSM8974InitializePort,
    MSM8974PutByte,
    MSM8974GetByte,
