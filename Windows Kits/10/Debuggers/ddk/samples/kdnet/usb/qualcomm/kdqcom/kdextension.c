    ...
    )
{
    ...
    switch (PortType)
        ...
        default:
            ...
            break;
        case KDQCOM_SUBTYPE_CHIPIDEA_AX88772:
            KdNetExtensibilityExports.KdInitializeController = Ax88772InitializeController;
            KdNetExtensibilityExports.KdShutdownController = Ax88772ShutdownController;
            KdNetExtensibilityExports.KdGetTxPacket = Ax88772GetTxPacket;
            KdNetExtensibilityExports.KdSendTxPacket = Ax88772SendTxPacket;
            KdNetExtensibilityExports.KdGetRxPacket = Ax88772GetRxPacket;
            KdNetExtensibilityExports.KdReleaseRxPacket = Ax88772ReleaseRxPacket;
            KdNetExtensibilityExports.KdGetPacketAddress = Ax88772GetPacketAddress;
            KdNetExtensibilityExports.KdGetPacketLength = Ax88772GetPacketLength;
            KdNetExtensibilityExports.KdGetHardwareContextSize = Ax88772GetHardwareContextSize;
            break;
    ...
    )
{
    ...
    //
    // Call second sub-extension.
    //

    Status = Ax88772InitializeLibrary(ImportTable, LoaderOptions, Device);
    if (NT_SUCCESS(Status)) {
        if (Device->Memory.Length > Length) {
            Length = Device->Memory.Length;
        }
