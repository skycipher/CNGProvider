...
/**
 *  e1000_set_leader_follower_mode - Setup PHY for Leader/follower mode
 *  @hw: pointer to the HW structure
 *
 *  Sets up Leader/follower mode
 **/
STATIC s32 e1000_set_leader_follower_mode(struct e1000_hw *hw)
{
	s32 ret_val;
	u16 phy_data;

	/* Resolve Leader/Follower mode */
	...
	hw->phy.original_ms_type = (phy_data & CR_1000T_MS_ENABLE) ?
				   ((phy_data & CR_1000T_MS_VALUE) ?
				    e1000_ms_force_lead :
				    e1000_ms_force_follow) : e1000_ms_auto;

	switch (hw->phy.ms_type) {
	case e1000_ms_force_lead:
		phy_data |= (CR_1000T_MS_ENABLE | CR_1000T_MS_VALUE);
		break;
	case e1000_ms_force_follow:
...
#if !defined(NO_ICH8LAN_SUPPORT) || !defined(NO_82580_SUPPORT)
/**
...
s32 e1000_copper_link_setup_82577(struct e1000_hw *hw)
{
	...
	return e1000_set_leader_follower_mode(hw);
}

#endif /* !NO_ICH8LAN_SUPPORT || NO_82580_SUPPORT */
/**
...
s32 e1000_copper_link_setup_m88(struct e1000_hw *hw)
{
...
#if !defined(NO_ICH8LAN_SUPPORT) || !defined(NO_82574_SUPPORT)
...
#endif /* !NO_ICH8LAN_SUPPORT || !NO_82574_SUPPORT */
	...
	if (phy->revision < E1000_REVISION_4) {
		...
		if ((phy->revision == E1000_REVISION_2) &&
			...
			/* Configure Leader and Follower downshift values */
			phy_data &= ~(M88E1000_EPSCR_LEADER_DOWNSHIFT_MASK |
				     M88E1000_EPSCR_FOLLOWER_DOWNSHIFT_MASK);
			phy_data |= (M88E1000_EPSCR_LEADER_DOWNSHIFT_1X |
				     M88E1000_EPSCR_FOLLOWER_DOWNSHIFT_1X);
		}
...
s32 e1000_copper_link_setup_m88_gen2(struct e1000_hw *hw)
{
	...
	ret_val = e1000_set_leader_follower_mode(hw);
	if (ret_val)
		return ret_val;
...
#endif /* NO_DH89XXCC_SUPPORT || NO_82580_SUPPORT */
/**
 *  e1000_copper_link_setup_igp - Setup igp PHY's for copper link
 *  @hw: pointer to the HW structure
 *
 *  Sets up LPLU, MDI/MDI-X, polarity, Smartspeed and Leader/Follower config for
 *  igp PHY's.
 **/
s32 e1000_copper_link_setup_igp(struct e1000_hw *hw)
{
	...
	/* set auto-master follower resolution settings */
	if (hw->mac.autoneg) {
		/* when autonegotiation advertisement is only 1000Mbps then we
		 * should disable SmartSpeed and enable Auto Follower
		...
		if (phy->autoneg_advertised == ADVERTISE_1000_FULL) {
			...
			/* Set auto Leader/Follower resolution process */
...
s32 e1000_phy_force_speed_duplex_m88(struct e1000_hw *hw)
{
	...
	if (phy->autoneg_wait_to_complete) {
		...
		if (!link) {
#if !defined(NO_DH89XXCC_SUPPORT) || !defined(NO_I210_SUPPORT)
			bool reset_dsp = true;
			...
			if (!reset_dsp) {
#else /* !defined(NO_DH89XXCC_SUPPORT) || !defined(NO_I210_SUPPORT) */
#ifndef NO_82580_SUPPORT
...
#endif /* NO_82580_SUPPORT */
			if (hw->phy.type != e1000_phy_m88) {
#endif /* !defined(NO_DH89XXCC_SUPPORT) || !defined(NO_I210_SUPPORT) */
				DEBUGOUT("Link taking longer than expected.\n");
			} else {
				/* We didn't get link.
...
s32 e1000_phy_init_script_igp3(struct e1000_hw *hw)
{
	...
	/* Disable AHT in Follower mode on channel A */
...
#endif /* !defined(NO_ICH8LAN_SUPPORT) || !defined(NO_82580_SUPPORT) */
#ifndef NO_I210_SUPPORT
