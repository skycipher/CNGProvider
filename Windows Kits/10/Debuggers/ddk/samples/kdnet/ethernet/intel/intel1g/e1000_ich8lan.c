...
#ifdef INTEL_KDNET
#define E1000_MUTEX_INIT(_x)
#define E1000_MUTEX_LOCK(_x)
#define E1000_MUTEX_UNLOCK(_x)
#endif
...
STATIC s32  e1000_read_nvm_ich8lan(struct e1000_hw *hw, u16 offset,
				   u16 words, /* kdnet */ __out_ecount(words) u16 *data);
STATIC s32  e1000_read_nvm_spt(struct e1000_hw *hw, u16 offset, u16 words,
			       /* kdnet */ __out_ecount(words) u16 *data);
...
#if !defined(NO_PCH_LPT_B0_SUPPORT)
	u16 pci_cfg;
