    ...
    )
{
    ...
    switch(choice) 
    {
        ...
        default:
                switch(fail)
                {
                    case 0:  return STATUS_INSUFFICIENT_RESOURCES;
...
{
    LONG choice = SdvMakeChoice();
    PMIB_IPINTERFACE_ROW x = malloc(1);
		...
		)
{
    ...
    switch(choice) 
    {
        ...
        default:
                ...
                {
                    case 0:  return STATUS_INSUFFICIENT_RESOURCES;
                    case 1:  return STATUS_NOT_FOUND;
                    case 2:  return STATUS_NOT_SUPPORTED;
                    default: return STATUS_UNSUCCESSFUL;
                }
    }
}		
		...
		)
{
    ...
    switch(choice) 
    {
        ...
        default:
                switch(fail)
                {
                    case 0:  return STATUS_ACCESS_DENIED;
                    case 1:  return STATUS_NOT_FOUND;
                    case 2:  return STATUS_NDIS_FILE_NOT_FOUND;
                    default: return STATUS_UNSUCCESSFUL;
                }
    }
}
...
{
    LONG choice = SdvMakeChoice();
    PMIB_UNICASTIPADDRESS_ROW x = malloc(1);
		...
		)
{
    ...
    if ( Table == NULL || NotificationHandle == NULL )
    {
            return STATUS_INVALID_PARAMETER;
    }
    switch(choice) 
		...
		)
{
    ...
    switch(choice) 
    {
        ...
        default:
                switch(fail)
                {
                    case 0:  return STATUS_NOT_SUPPORTED;
                    case 1:  return STATUS_DEVICE_NOT_READY;
                    default: return STATUS_UNSUCCESSFUL;
                }
    }
}
    ...
    switch(choice) 
    {
        ...
        default:
                switch(fail)
                {
                    case 0:  return STATUS_NOT_SUPPORTED;
                    case 1:  return STATUS_NOT_FOUND;
                    case 2:  return STATUS_BAD_NETWORK_NAME;
                    default: return STATUS_UNSUCCESSFUL;
                }
    }
}
...
{
    LONG choice = SdvMakeChoice();
    PNET_IF_COMPARTMENT_ID x = malloc(1);
		...
		)
{
    LONG choice = SdvMakeChoice();
    LONG fail = SdvMakeChoice();
    PMIB_IPFORWARD_ROW2 x = malloc(1);
    SOCKADDR_INET * y = malloc(1);
    
    if ( DestinationAddress == NULL || BestSourceAddress == NULL || BestRoute == NULL ) 
    { 
        return STATUS_INVALID_PARAMETER; 
    }  
    switch(choice) 
		...
		)
{
    LONG choice = SdvMakeChoice();
    LONG fail = SdvMakeChoice();
    ULONG x = SdvMakeChoice();
    
    switch(choice) 
    {
        case 0:
              *SortedAddressPairList = malloc(1);
              *SortedAddressPairCount = x;
              return STATUS_SUCCESS;
        default:
              switch(fail)
                {
